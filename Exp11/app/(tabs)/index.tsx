...
function AnimeSearchApp() {
  ...
  const [sortBy, setSortBy] = useState('popularity'); // popularity, score
  ...
  const searchAnime = async () => {
    ...
    try {
      ...
      if (filterType) {
        results = results.filter((item: any) => item.type === filterType);
      }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.filterRow}>
        <TouchableOpacity
          ...
          style={[styles.filterBtn, !filterType && styles.activeBtn]}
        >
          <Text style={styles.filterText}>All</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => setFilterType('TV')}
          style={[styles.filterBtn, filterType === 'TV' && styles.activeBtn]}
        >
          <Text style={styles.filterText}>TV</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => setFilterType('Movie')}
          style={[styles.filterBtn, filterType === 'Movie' && styles.activeBtn]}
        >
          <Text style={styles.filterText}>Movies</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => setFilterType('OVA')}
          style={[styles.filterBtn, filterType === 'OVA' && styles.activeBtn]}
        >
      ...
      <View style={styles.filterRow}>
        <TouchableOpacity
          ...
          style={[styles.filterBtn, sortBy === 'popularity' && styles.activeBtn]}
        >
          <Text style={styles.filterText}>Popularity</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => setSortBy('score')}
          style={[styles.filterBtn, sortBy === 'score' && styles.activeBtn]}
        >
...
registerRootComponent(AnimeSearchApp);
